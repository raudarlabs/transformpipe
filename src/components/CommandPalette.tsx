 ...
 *
 * The bar at the top of the screen holds fifteen conversions behind a menu, three destinations and
...
export function CommandPalette({
  ...
  const matches = useMemo(() => {
     ...
     * palette that opened on forty file names would bury the fifteen conversions under them.
     */
