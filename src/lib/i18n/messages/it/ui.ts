...
export const ui: Content['ui'] = {
  ...
  'header.nav.agents': 'Assistenti AI',
   ...
   */
  'article.cta.title': 'Converti un file mentre leggi',
  'article.cta.blurb': 'Succede nel tuo browser: non viene caricato nulla e non c’è alcun account da creare.',
   ...
   */
  'agents.copied': 'Copiato — incollalo nelle impostazioni dei connettori del tuo assistente',
  'agents.can': 'Può',
  'agents.cannot': 'Non può',
  'agents.col.assistant': 'Assistente',
