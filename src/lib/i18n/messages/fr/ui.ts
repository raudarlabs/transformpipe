...
export const ui: Content['ui'] = {
  ...
  'auth.dialog.aside.history.detail': 'chaque document converti est conservÃ© et se rouvre',
  'auth.dialog.aside.links': 'Liens',
  'auth.dialog.aside.links.detail': 'partager un document avec tout le monde ou avec des personnes nommÃ©es',
  'auth.dialog.aside.api': 'API et MCP',
  'auth.dialog.aside.api.detail': 'une clÃ© pour la CLI, la GitHub Action et votre assistant',
  'auth.dialog.aside.extension': 'L’extension',
  'auth.dialog.aside.extension.detail': 'le mÃªme compte, connectÃ© depuis votre navigateur',
