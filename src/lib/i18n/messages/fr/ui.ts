...
export const ui: Content['ui'] = {
   ...
   */
  'article.cta.title': 'Convertissez un fichier pendant votre lecture',
  'article.cta.blurb': 'Tout se passe dans votre navigateur : rien n’est téléversé, et il n’y a aucun compte à créer.',
