...
export const ui: Content['ui'] = {
  ...
  'auth.dialog.aside.lede': 'La cuenta no es lo importante. Lo que guarda, sÃ­.',
  ...
  'auth.dialog.aside.extension': 'La extensiÃ³n',
  'auth.dialog.aside.extension.detail': 'la misma cuenta, con sesiÃ³n iniciada desde tu navegador',
