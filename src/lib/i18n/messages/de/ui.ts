...
export const ui: Content['ui'] = {
  ...
  'auth.dialog.aside.history.detail': 'jedes konvertierte Dokument bleibt erhalten und lÃ¤sst sich erneut Ã¶ffnen',
  'auth.dialog.aside.links': 'Links',
  'auth.dialog.aside.links.detail': 'ein Dokument fÃ¼r alle freigeben oder fÃ¼r bestimmte Personen',
  'auth.dialog.aside.api': 'API und MCP',
  'auth.dialog.aside.api.detail': 'ein SchlÃ¼ssel fÃ¼r die CLI, die GitHub Action und Ihren Assistenten',
