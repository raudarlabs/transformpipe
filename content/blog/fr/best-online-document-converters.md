...
À celui qui échoue sur votre document, pas à celui qui affiche la plus longue liste de formats. Les outils locaux se séparent sur ce qu'ils refusent d'emblée : Pandoc ne lit les présentations que depuis la 3.8.3 et n’en prend aucune note, calibre n'atteint Markdown que par son exporteur de texte, et Docling lit la plus large liste d'entrées de tous. [Dix convertisseurs Markdown comparés par ce qu'ils refusent de lire](/blog/ten-markdown-converters-compared) rassemble ces refus dans un tableau daté, chaque point venant de la documentation de l'outil concerné.
