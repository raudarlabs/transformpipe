...
Mit dem, was an Ihrem Dokument scheitert, nicht mit dem, das die längste Formatliste hat. Die lokalen Werkzeuge unterscheiden sich darin, was sie glatt verweigern — Pandoc liest Präsentationen erst seit 3.8.3 und nimmt keine ihrer Notizen mit, calibre erreicht Markdown nur über seinen Textexporter, und Docling liest die breiteste Eingabeliste von allen. [Zehn Markdown-Konverter, verglichen nach dem, was sie nicht lesen](/blog/ten-markdown-converters-compared) stellt diese Verweigerungen in eine Tabelle, mit Datum und mit jedem Punkt aus der Dokumentation des jeweiligen Werkzeugs.
